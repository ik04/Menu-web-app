...
Route::middleware(['auth:sanctum'])->group(function (){
    Route::post("/v1/healthcheck",[ItemController::class,"healthCheck"]);
    Route::post("/v1/logout",[UserController::class,"logout"]);
    // * ORDER ROUTES 
    Route::post("/v1/add-order",[OrderController::class,"addOrder"]);
    Route::delete("/v1/delete-order",[OrderController::class,"deleteOrder"]);
    ...
    Route::get("/v1/get-pending-orders",[OrderController::class,"getUserPendingOrders"]); // * checkout route instead
});
